...
public class VioAdmobConfig {
     ...
     */
    private int numberOfTimesReloadAds = 0;

    public int getNumberOfTimesReloadAds() {
        return numberOfTimesReloadAds;
    }

    public void setNumberOfTimesReloadAds(int numberOfTimesReloadAds) {
        this.numberOfTimesReloadAds = numberOfTimesReloadAds;
    }
    ...
    private String idAdResumeMedium;
    private String idAdResumeHigh;
    ...
    public VioAdmobConfig(Application application) {
        this.application = application;
    }

    public VioAdmobConfig(Application application, int mediationProvider, String environment) {
    ...
    public String getIdAdResumeMedium() {
        return idAdResumeMedium;
    }

    public String getIdAdResumeHigh() {
        return idAdResumeHigh;
    }
    ...
    public void setIdAdResumeMedium(String idAdResumeMedium) {
        this.idAdResumeMedium = idAdResumeMedium;
    }

    public void setIdAdResumeHigh(String idAdResumeHigh) {
        this.idAdResumeHigh = idAdResumeHigh;
    }
