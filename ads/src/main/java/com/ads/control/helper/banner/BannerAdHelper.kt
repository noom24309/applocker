...
class BannerAdHelper(
            ...
            is AdBannerState.Loaded -> {
                ...
                if (bannerContentView != null && shimmerLayoutView != null) {
                    ...
                    bannerContentView.let {
                        val heightDivider =
                            it.context.resources.getDimensionPixelOffset(com.intuit.sdp.R.dimen._1sdp)
                        it.removeAllViews()
    ...
    private fun loadBannerAd() {
        if (canRequestAds()) {
            ...
            // Check collapsibleGravity value
            if (!config.collapsibleGravity.isNullOrEmpty()) {
                // ✅ Load adaptive collapsible banner
                ...
                // ✅ Load normal (non-collapsible) adaptive banner
                VioAdmob.getInstance()
                    .requestLoadBanner(
                        activity,
                        config.idAds,
