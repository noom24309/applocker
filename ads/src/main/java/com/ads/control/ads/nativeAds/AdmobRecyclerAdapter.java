...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final VioAdPlacerSettings settings;

    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private VioAdPlacer adPlacer;
    private AdapterDataObserver adapterDataObserver = new AdapterDataObserver();
    private boolean canRecyclable = false;
    private boolean isNativeFullScreen = false;

    public AdmobRecyclerAdapter(VioAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new VioAdPlacer(settings, adapterOriginal, activity);
    }
    ...
    private class VioViewHolder extends RecyclerView.ViewHolder {
        public VioViewHolder(@NonNull View itemView) {
            super(itemView);
        }
